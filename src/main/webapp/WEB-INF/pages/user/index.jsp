...
<div class="header bg-main">
    <div class="logo margin-big-left fadein-top">
        <h1><img src="${bathpath}/images/y.jpg" class="radius-circle rotate-hover" height="50" alt="" />后台管理中心</h1>
    </div>
...
<div class="leftnav">
    ...
    <ul style="display:block">
        <li><a href="${bathpath}/user/list" target="right"><span class="icon-caret-right"></span>用户管理</a></li>
    </ul>
</div>
